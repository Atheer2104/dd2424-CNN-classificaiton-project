...
def SE_resnet20(num_classes):
    return ResNet(SE_ResNetBlock, [3, 3, 3], num_classes)


def SE_resnet32(num_classes):
    return ResNet(SE_ResNetBlock, [5, 5, 5], num_classes)


def SE_resnet44(num_classes):
    return ResNet(SE_ResNetBlock, [7, 7, 7], num_classes)


def SE_resnet56(num_classes):
    return ResNet(SE_ResNetBlock, [9, 9, 9], num_classes)


def SE_resnet110(num_classes):
    return ResNet(SE_ResNetBlock, [18, 18, 18], num_classes)
